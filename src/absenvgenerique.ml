...
(*    val merge_he : he list -> he list -> he list
    ...
    val get_value_create: absenv -> nameVal -> ((int*int)*string*int) list -> absenv * valuesSet
    ...
    val get_value_string_create : absenv -> string ->  ((int*int)*string*int) list -> absenv *valuesSet
