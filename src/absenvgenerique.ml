...
sig
    ...
    val init_vs_chunk : int -> chunk_t -> Gueb_type.call_stack -> valuesSet
    val init_chunk : int -> chunk_t -> Gueb_type.call_stack -> he
    val new_init_memory : int ref-> Gueb_type.call_stack ->  valuesSet    
...
(*    val merge_he : he list -> he list -> he list
    ...
    val get_value_create: absenv -> nameVal -> Gueb_type.call_stack -> absenv * valuesSet
    val set_value : absenv -> nameVal-> valuesSet -> absenv
    val get_chunk_key : he -> int* chunk_t
    val get_chunk_states : he -> Gueb_type.call_stack * (Gueb_type.call_stack) list
 
    val get_value_string : absenv -> string -> valuesSet
    val get_value_string_create : absenv -> string ->  Gueb_type.call_stack -> absenv *valuesSet
    ...
    val free : absenv -> valuesSet -> Gueb_type.call_stack -> bool -> unit
